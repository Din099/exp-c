//Makefile for automation of generating binary file from .as file and run it on riscv qemu
//and looking inside cpu while the program is running and checking the registers for its states
compile: m.s m.ld
